...
### 136 & 137
按位异或，非常巧妙！！！<br>
137是推广，one和two，记录的是00，01状态，而three是个标志11状态，一旦three为1也就是三进制达到11状态，则进位，one，two则为0（00）状态137是推广，one和two，记录的是00，01状态，而three是个标志11状态，一旦three为1也就是三进制达到11状态，则进位，one，two则为0（00）状态137是推广，one和two，记录的是00，01状态，而three是个标志11状态，一旦three为1也就是三进制达到11状态，则进位，one，two则为0（00）状态137是推广，one和two，记录的是00，01状态，而three是个标志11状态，一旦three为1也就是三进制达到11状态，则进位，one，two则为0（00）状态137是推广，one和two，记录的是00，01状态，而three是个标志11状态，一旦three为1也就是三进制达到11状态，则进位，one，two则为0（00）状态137是推广，one和two，记录的是00，01状态，而three是个标志11状态，一旦three为1也就是三进制达到11状态，则进位，one，two则为0（00）状态
